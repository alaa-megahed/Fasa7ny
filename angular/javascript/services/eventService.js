app.factory('Event', ['$http', function($http) {
    return {
        get : function(eventId) {
          console.log(eventId);
          console.log("!!");
            return $http.get('http://54.187.92.64:3000/event/getOnceEventDetails/' + eventId);
        },

        delete : function(id){
        	console.log("delete service");
        	return $http.get('http://54.187.92.64:3000/event/cancel/'+ id);
        ...
        edit : function(formData,id){
          ...
          if(formData.starttime && formData.endtime) {
        	...
        	return $http.post('http://54.187.92.64:3000/event/edit/'+id, formData);
        },
        ...
        deleteImage : function(eventId, image) {
          ...
          console.log(eventId);
          console.log(image);
          return $http.get('http://54.187.92.64:3000/event/deleteImage/' + eventId + "/" + image);
        },
        ...
        addImage : function(eventId, formData) {
          ...
          console.log(fd);
          return $http.post('http://54.187.92.64:3000/event/addImage/' + eventId, fd, {
