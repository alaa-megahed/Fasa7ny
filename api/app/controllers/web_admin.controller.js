                                            ...
                                            if (err)
                                                ...
                                                business.save(function (err, updatedBusiness) {
                                                    ...
                                                    if (err)
                                                        ...
                                                        //populate busines stats records with 0 values 
                                                        var now = new Date();
                                                        now.setHours(0, 0, 0, 0);
                                                        statsController.addStat(now, updatedBusiness._id, 'views', 0);
                                                        //schedule more records to be added in the future 
                                                        statsController.schedule(updatedBusiness._id);
